package com.caym.pokeapi.service.characteristic.controllers;
...
import com.caym.pokeapi.service.characteristic.services.CharacteristicService;
...
public class CharacteristicRestController {
	...
	@GetMapping("/{idOrName}")
	public Characteristic IdOrName(@PathVariable String idOrName){
