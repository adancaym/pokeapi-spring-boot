package com.caym.pokeapi.service.machine.controllers;
...
import com.caym.pokeapi.service.machine.services.MachineService;
...
public class MachineRestController {
	...
	@GetMapping("/{idOrName}")
	public Machine IdOrName(@PathVariable String idOrName){
