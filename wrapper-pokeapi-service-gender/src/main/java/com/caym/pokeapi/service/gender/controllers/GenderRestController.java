package com.caym.pokeapi.service.gender.controllers;
...
import com.caym.pokeapi.service.gender.services.GenderService;
...
public class GenderRestController {
	...
	@GetMapping("/{idOrName}")
	public Gender IdOrName(@PathVariable String idOrName){
