package com.caym.pokeapi.service.item.category.controllers;
...
import com.caym.pokeapi.service.item.category.services.ItemCategoryService;
...
public class ItemCategoryRestController {
	...
	@GetMapping("/{idOrName}")
	public ItemCategory IdOrName(@PathVariable String idOrName){
