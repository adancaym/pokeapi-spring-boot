package com.caym.pokeapi.service.berry.controller;
...
@RestController
public class BerryRestController {

	@Autowired 
	BerryService service;
	...
	@GetMapping("/{idOrName}")
	public Berry IdOrName(@PathVariable String idOrName){
